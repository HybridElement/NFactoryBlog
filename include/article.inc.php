...
if(isset($_POST["article"])) {
    ...
    if(count($tabErreur) != 0) {
        ...
        if (!$connexion) {
            ...
            $message = addslashes(html_entity_decodee($message , ENT_HTML5 ,string $encoding = ini_get("default_charset") ));
            $chapo=addslashes(html_entity_decode($chapo));
            $titre=addslashes(html_entity_decode($titre));
